(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-services")) new swiper_core_Swiper(".slider-services", {
        ...
        if (document.querySelector(".programs__slider")) new swiper_core_Swiper(".programs__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".slider-plarform")) new swiper_core_Swiper(".slider-plarform", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            pagination: {
                el: ".slider-plarform__pagination",
                clickable: true
            },
            on: {}
        });
    ...
    da.init();
    let ge = document.querySelectorAll(".menu__link");
    for (let e = 0; e < ge.length; e++) new URL(ge[e].getAttribute("href"), window.location.origin).pathname == window.location.pathname && ge[e].classList.add("active");
    window["FLS"] = false;
    menuInit();
    spollers();
    formFieldsInit({
